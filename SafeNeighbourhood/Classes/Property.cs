...
namespace QuickType
{
    ...
    public partial class Property
    {
        public static List<Property> FromJson(string json) => JsonConvert.DeserializeObject<List<Property>>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Property> self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
